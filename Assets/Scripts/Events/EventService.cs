...
public class EventService
{
    ...
    public EventController<int> IncreaseScore;
    public EventController OnWordCollected;
    public EventService() 
    {
        ...
        IncreaseScore = new EventController<int>();
        OnWordCollected = new EventController();
    }
}